            ...
            func: function (req, res, next) {
                ...
                res.view = function () {
                    ...
                    options.render = function (viewName, opts) {
                        return helper.viewHelper.render(viewName, avril.extend(options, opts));
                    }
                    res.header('Content-Type', 'text/html');

                    var str = helper.viewHelper.render(viewName, options)
                    avril.log(str);
                    res.end(str);
...
(function () {
    ...
    ViewHelper.prototype.render = function (viewName, options) {
        ...
        var compiledView = compiledViewFunc(options);
...
function HelperBase(app, req, res, routes, ctrlCfgCache, mvc) {
    ...
    this.controllConfig = function () { return _ctrlCfgCache; }
    this.mvc = function () {
        return _mvc;
    }

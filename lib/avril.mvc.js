        ...
        return {
            func: function (req, res, next) {
                ...
                res.view = function () {
                    ...
                    if (req.param('__reqtype') != 'clientmvc') {
...
(function () {
    ...
    HtmlHelper.prototype.resourceScript = function (resourceName, combine, version, scriptList, attrs) {

        var appConfig = avril.getConfig('app') || {}
        , scriptResources = avril.getConfig('scriptResources') || {};

        version = version || scriptResources.version || appConfig.version;
        ...
        if (scriptList && (scriptList instanceof Array)) {
            if (combine) {
                var fileName = resourceName + '-' + version + (appConfig.minifyJsEx || '.js');
    ...
    HtmlHelper.prototype.resourceStyle = function (resourceName, combine, version, styleList, attrs) {
        var appConfig = avril.getConfig('app') || {}
        ...
        if (styleList && (styleList instanceof Array)) {
            if (combine) {
                ...
                var fileName = resourceName + '-' + version + (appConfig.minifyCssEx || '.css');

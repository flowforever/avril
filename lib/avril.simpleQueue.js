...
module.exports = (function() {
    function $AwaitData(queue, key) {
        ...
        this.result = function(value) {
            if(reader && arguments.length == 0){
                return reader(this.queue.data(this.key));
            }
            if(arguments.length == 1){
        ...
        var eachCbFactory = function(isParal){
            return function(asyncCall , eachArgs, fn) {
				...
				this.func(function(next) {
					...
					var $list = avril.isArray(eachArgs) && eachArgs.map(function(arg) {
                    ...
                    avril.isArray(eachArgs) && eachArgs.length && subQueue.func(function(){ next() });

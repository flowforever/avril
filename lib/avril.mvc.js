...
(function () {
    ...
    var resourceScriptList = HtmlHelper.prototype.resourceScriptList = function (resourceName, combine, version, scriptList, minifyEx) {
    ...
    HtmlHelper.prototype.resourceScript = function (resourceName, combine, version, scriptList, attrs, minifyEx) {
        ...
        return resourceScriptList(resourceName, combine, version, scriptList, minifyEx)
        .map(function (path) {

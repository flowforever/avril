...
Page.mongoose = function (model, query, callback, currentIndex, pageSize) {
    ...
    model.count(query, function (err,size) {
        ...
        model.find(query).skip(page.pageSize() * page.currentIndex()).limit(page.pageSize()).exec(function (err, docs) {
